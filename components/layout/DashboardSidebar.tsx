  ...
  return (
    ...
    >
      ...
      <div className="px-6 py-4">
        <div className="p-3 rounded-2xl bg-slate-50 dark:bg-white/[0.02] border" style={{ borderColor: "var(--wg-border)" }}>
          <div className="flex items-center gap-2 mb-2">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
            <span className="text-[10px] font-black uppercase tracking-widest opacity-40">Status Système</span>
          </div>
          <div className="flex flex-col gap-1">
            <div className="flex justify-between text-[9px] font-bold">
              <span className="opacity-40">Serveurs</span>
              <span className="text-emerald-500">Opérationnel</span>
            </div>
            <div className="flex justify-between text-[9px] font-bold">
              <span className="opacity-40">IA Engine</span>
